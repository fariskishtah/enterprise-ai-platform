...
const paths: Record<NavigationIcon | UtilityIcon, ReactElement> = {
  ...
  chat: (
    <path d="M4.5 5.25h15a1.5 1.5 0 0 1 1.5 1.5v9a1.5 1.5 0 0 1-1.5 1.5H10l-4.5 3v-3h-1a1.5 1.5 0 0 1-1.5-1.5v-9a1.5 1.5 0 0 1 1.5-1.5ZM7.5 9h9M7.5 13h6" />
  ),
  ...
  datasets: (
    <path d="M4 6c0-1.1 3.58-2 8-2s8 .9 8 2-3.58 2-8 2-8-.9-8-2Zm0 0v6c0 1.1 3.58 2 8 2s8-.9 8-2V6M4 12v6c0 1.1 3.58 2 8 2s8-.9 8-2v-6" />
  ),
  factories: (
    <path d="M3 20.25h18M4.5 20.25V9l5.25 3V9l5.25 3V4.5h4.5v15.75M7.5 16.5h.75m3 0H12m3 0h.75" />
  ),
  knowledge: (
    <path d="M4.5 4.5h6.75A2.75 2.75 0 0 1 14 7.25V20a3.5 3.5 0 0 0-3.5-3.5h-6V4.5Zm15 0h-5.25M19.5 4.5v12h-2A3.5 3.5 0 0 0 14 20" />
  ),
