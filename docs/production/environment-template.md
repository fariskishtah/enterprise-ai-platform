...
PAYMOB_API_KEY=<dashboard-api-key-if-required>
PAYMOB_SECRET_KEY=<server-only-sk_live-key>
PAYMOB_PUBLIC_KEY=<pk_live-key>
PAYMOB_HMAC_SECRET=<server-only-dashboard-hmac-secret>
PAYMOB_INTEGRATION_ID=<enabled-egypt-payment-method-id>
PAYMOB_IFRAME_ID=
PAYMOB_BASE_URL=https://accept.paymob.com
PAYMOB_WEBHOOK_URL=https://platform.example/api/billing/webhooks/paymob
PAYMENT_SUCCESS_URL=https://platform.example/billing/success
PAYMENT_FAILURE_URL=https://platform.example/billing/failure
